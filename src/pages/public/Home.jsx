              ...
              >
                ...
                <div className="grid gap-4 lg:grid-cols-[0.95fr_1.08fr]">
                  <div className="grid gap-4">
                    <div className="rounded-[1.75rem] border border-[#8b5a3a]/30 bg-gradient-to-br from-[#5b3925]/96 via-[#4d2d20]/94 to-[#24130d]/99 p-4 min-h-[7.9rem] flex flex-col justify-between text-right shadow-[inset_0_1px_0_rgba(255,255,255,0.035)]">
                  ...
                  <div className="rounded-[1.75rem] border border-[#8b5a3a]/30 bg-gradient-to-br from-[#5b3925]/96 via-[#4d2d20]/94 to-[#24130d]/99 p-4 min-h-[16.5rem] flex flex-col justify-between text-right shadow-[inset_0_1px_0_rgba(255,255,255,0.035)]">
                ...
                <div className="mt-4 grid gap-4">
                  <div className="rounded-[1.45rem] border border-[#8b5a3a]/30 bg-gradient-to-br from-[#5b3925]/96 via-[#4d2d20]/94 to-[#24130d]/99 px-5 py-4 flex items-center justify-between gap-6">
