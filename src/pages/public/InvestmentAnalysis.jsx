...
const analysisTracks = [
  ...
  },
  {
    ...
    description: 'غيّر المساحة أو التكاليف أو الإيراد المتوقع لتعرف أثرها على العائد قبل الالتزام.',
...
const InvestmentAnalysis = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!token) {
      addToast('سجّل الدخول أولًا لحفظ تقييمك والرجوع إليه لاحقًا.', 'error');
      return;
    }
          ...
          <Card className="p-6 lg:p-8">
            ...
            {latestReport ? (
              ...
              <div className="mt-6 rounded-[1.5rem] border border-[#ead9c7] bg-white/55 p-6">
                ...
                <p className="mt-3 text-sm leading-8 text-app-text-muted">
                  بعد إرسال التقييم سيظهر هنا تقرير يتضمن نسبة العائد، فترة الاسترداد، وملخصًا ماليًا يساعدك على مراجعة الفكرة أو عرضها.
                </p>
              </div>
            )}
          </Card>
