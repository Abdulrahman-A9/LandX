        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2 group">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-primary-400 to-secondary-400 bg-clip-text text-transparent">لاند إكس</span>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-dark-400 text-sm">
                <li><Link to="/opportunities" className="hover:text-primary-400 transition-all duration-300 hover:translate-x-1">الفرص الاستثمارية</Link></li>
                <li><Link to="/news" className="hover:text-primary-400 transition-all duration-300 hover:translate-x-1">الأخبار</Link></li>
                <li><Link to="/about" className="hover:text-primary-400 transition-all duration-300 hover:translate-x-1">عن المنصة</Link></li>
                <li><Link to="/contact" className="hover:text-primary-400 transition-all duration-300 hover:translate-x-1">تواصل معنا</Link></li>
              </ul>
            </div>
            
            <div>
              <h3 className="font-semibold mb-4 text-white">المناطق</h3>
              <ul className="space-y-2 text-dark-400 text-sm">
                <li><Link to="/opportunities?region=hail" className="hover:text-primary-400 transition-all duration-300 hover:translate-x-1">منطقة حائل</Link></li>
                <li><Link to="/opportunities?region=qassim" className="hover:text-primary-400 transition-all duration-300 hover:translate-x-1">منطقة القصيم</Link></li>
                <li><Link to="/opportunities?region=tabuk" className="hover:text-primary-400 transition-all duration-300 hover:translate-x-1">منطقة تبوك</Link></li>
              </ul>
            </div>
            
            <div>
              <h3 className="font-semibold mb-4 text-white">تواصل معنا</h3>
              <ul className="space-y-2 text-dark-400 text-sm">
                <li>info@landx.sa</li>
