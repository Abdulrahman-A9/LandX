  ...
  return (
    <div>
      <PageHero
        ...
        title="اختر الفرصة التي تناسب أهدافك الاستثمارية."
        description="قارن بين الفرص المنشورة، راجع المؤشرات الأساسية، وتواصل مع الجهة المعلنة عندما تجد خيارك المناسب."
      />
