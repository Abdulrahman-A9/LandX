...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-[#8f4f2d] via-[#aa653c] to-[#c38256] text-[#fff8f0] shadow-lg shadow-brand/20 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-brand/25 focus:ring-brand',
    secondary: 'border border-brand/20 bg-[#fffaf4] text-app-text hover:bg-[#f7ecdf] hover:border-brand/30 focus:ring-brand',
    outline: 'border border-app-border bg-white/50 text-app-text hover:bg-white/80 hover:border-brand/30 focus:ring-brand',
