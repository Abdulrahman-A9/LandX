  ...
  theme: {
    extend: {
      colors: {
        ...
        'app-bg': '#1c120d',
        'app-bg-soft': '#261813',
        'app-surface': 'rgba(47, 29, 20, 0.82)',
        'app-surface-strong': 'rgba(62, 39, 27, 0.92)',
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(135deg, #140c09 0%, #21140e 32%, #160d09 70%, #1f120d 100%)',
        'card-gradient': 'linear-gradient(135deg, rgba(47, 29, 20, 0.82) 0%, rgba(62, 39, 27, 0.92) 100%)',
        'card-gradient-strong': 'linear-gradient(135deg, rgba(62, 39, 27, 0.92) 0%, rgba(83, 50, 34, 0.98) 100%)',
        'header-gradient': 'linear-gradient(135deg, #8a4d2a 0%, #5d2d19 50%, #140c09 100%)',
