...
const AdminModeration = () => {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-app-text">الإشراف</h1>
        <p className="mt-2 text-app-text-muted">قائمة عناصر تحتاج انتباهاً إدارياً حسب الحالة الحالية في النظام.</p>
      </div>
      ...
      <Card className="bg-card-gradient border border-app-border">
        <div className="p-6 border-b border-app-border">
          <h2 className="text-xl font-bold text-app-text">العناصر التي تحتاج متابعة</h2>
        </div>
            ...
            <div key={item.id} className="rounded-lg border border-app-border bg-app-surface-soft p-4">
              <div className="mb-3 flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-app-text-muted">{item.meta}</p>
                </div>
              </div>
