...
const InvestorJourney = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-950 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-secondary-400 mb-4 animate-fade-in">
            رحلة المستثمر
          </h1>
        ...
        <div className="mb-16 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <Card className="bg-card-gradient border border-primary-500/30 p-8">
            <h2 className="text-2xl font-bold text-white mb-2 text-center">المخطط البصري للرحلة</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold mb-2">ابدأ</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold mb-2">افهم بسرعة</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold mb-2">تعمق عند الحاجة</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold mb-2">احسم القرار</h3>
        ...
        <div className="mb-16 animate-fade-in" style={{ animationDelay: '0.8s' }}>
          <h2 className="text-2xl font-bold text-white mb-6 text-center">ابدأ من المسار الاستشاري</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-card-gradient border border-primary-500/30 p-6 hover:border-primary-500/50 transition-all duration-300">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">مستثمر لديه فرصة جاهزة</h3>
            ...
            <Card className="bg-card-gradient border border-secondary-500/30 p-6 hover:border-secondary-500/50 transition-all duration-300">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">مستثمر لديه فكرة وليس لديه موقع</h3>
            ...
            <Card className="bg-card-gradient border border-accent-500/30 p-6 hover:border-accent-500/50 transition-all duration-300">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">مستثمر متردد ويخاف من التعقيد</h3>
            ...
            <Card className="bg-card-gradient border border-primary-500/30 p-6 hover:border-primary-500/50 transition-all duration-300">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">مستثمر يحتاج شريكاً أو دعماً تنفيذياً</h3>
        ...
        <div className="mb-16 animate-fade-in" style={{ animationDelay: '0.9s' }}>
          <Card className="bg-card-gradient border border-primary-500/30 p-8">
            <h2 className="text-2xl font-bold text-white mb-6 text-center">الإجراءات التي يمر بها المستثمر فعلياً</h2>
        ...
        <div className="animate-fade-in" style={{ animationDelay: '1s' }}>
          <h2 className="text-2xl font-bold text-white mb-6 text-center">كيف تنتهي الرحلة؟</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-gradient-to-r from-green-500/10 to-green-600/10 border border-green-500/30 p-6 hover:border-green-500/50 transition-all duration-300">
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-3">الانتقال للتقديم الرسمي</h3>
              </div>
            ...
            <Card className="bg-gradient-to-r from-primary-500/10 to-secondary-500/10 border border-primary-500/30 p-6 hover:border-primary-500/50 transition-all duration-300">
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-3">طلب استشارة أو شراكة قبل التقديم</h3>
              </div>
              <p className="text-dark-300 text-sm text-center">
            ...
            <Card className="bg-gradient-to-r from-red-500/10 to-red-600/10 border border-red-500/30 p-6 hover:border-red-500/50 transition-all duration-300">
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-3">رفض واعٍ للفرصة</h3>
              </div>
              <p className="text-dark-300 text-sm text-center">
