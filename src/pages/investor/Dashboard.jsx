...
const InvestorDashboard = () => {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-brown-900">لوحة المستثمر</h1>
        <p className="text-brown-700 mt-2">نظرة عامة على استثماراتك</p>
      </div>
          ...
          <div className="space-y-4">
            {[1, 2].map((i) => (
              <div key={i} className="flex items-center justify-between p-4 bg-pearl-100/50 border border-brown-300 rounded-lg">
                <div>
                  <p className="font-medium text-brown-900">حائل - وادي حائل الزراعي</p>
                  <p className="text-sm text-brown-700">الموسم الشتوي 2024</p>
                </div>
                <div className="text-left">
                  <p className="font-bold text-green-600">15%</p>
                  <p className="text-xs text-brown-600">عائد متوقع</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <Card className="p-6 bg-card-gradient border border-brown-300">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-brown-900">تم قبول طلب استثمارك في وادي حائل</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-brown-900">تم إرسال استفسارك إلى البلدية</p>
                <p className="text-sm text-brown-600">منذ يوم</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-brown-400 rounded-full mt-2"></div>
              <div>
                <p className="text-brown-900">تم تحديث معلومات الفرصة</p>
                <p className="text-sm text-brown-600">منذ 3 أيام</p>
              </div>
            </div>
          </div>
        </Card>
