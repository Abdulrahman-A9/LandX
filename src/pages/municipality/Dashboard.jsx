...
import { CheckIcon, DollarSignIcon, FileTextIcon, LeafIcon } from '../../components/ui/Icons';
      ...
      <section className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        ...
        <Card className="p-7">
          ...
          <div className="mt-4 rounded-2xl border border-warning/20 bg-warning/10 p-5">
            ...
            <div className="mt-2 text-sm leading-7 text-app-text-muted">استفسارات مفتوحة تحتاج فرزاً أو رداً.</div>
          </div>
        </Card>
      </section>
