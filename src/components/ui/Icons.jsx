...
export const LeafIcon = ({ className = '' }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 22C2 22 8 18 12 18C16 18 22 22 22 22" />
    <path d="M12 2C7.5 2 4 6.5 4 10C4 13.5 7.5 18 12 18C16.5 18 20 13.5 20 10C20 6.5 16.5 2 12 2Z" />
    <path d="M12 2C12 2 10 8 10 12C10 16 12 18 12 18" />
    <path d="M12 2C12 2 14 8 14 12C14 16 12 18 12 18" />
  </svg>
);
...
export const MegaphoneIcon = ({ className = '' }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 11V9a4 4 0 0 1 4-4h14a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2H7a4 4 0 0 1-4-4Z" />
    <path d="M7 11v4a2 2 0 0 0 2 2h1" />
    <path d="M15 11v6" />
  </svg>
);
...
export const LightbulbIcon = ({ className = '' }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M10 22h4" />
    <path d="M12 2v1" />
    <path d="M12 2a7 7 0 0 1 7 7c0 2-1 3.9-3 5.5s-3 3.5-3 5.5H8c0-2-1-3.9-3-5.5S2 11 2 9a7 7 0 0 1 7-7" />
  </svg>
);

export const HandshakeIcon = ({ className = '' }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m11 17 2 2a1 1 0 1 0 3-1.41l-5.83-5.84a2 2 0 0 0-2.83 0L2 12" />
    <path d="m2 7 4.41 4.41a2 2 0 0 0 2.83 0l.17-.17a1 1 0 0 1 1.41 0l3.59 3.59a1 1 0 0 0 1.41 0l.17-.17a2 2 0 0 0 0-2.83L9 7" />
    <path d="m15 12-3.59-3.59a2 2 0 0 1 0-2.83l.17-.17a1 1 0 0 1 1.41 0L22 7" />
  </svg>
);
...
export const HeartHandshakeIcon = ({ className = '' }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M19.414 14.414C21 12.828 22 11.5 22 9.5a5.5 5.5 0 0 0-9.591-3.676.6.6 0 0 1-.818.001A5.5 5.5 0 0 0 2 9.5c0 2.3 1.5 4 3 5.5l5.535 5.362a2 2 0 0 0 2.879.052 2.12 2.12 0 0 0-.004-3 2.124 2.124 0 1 0 3-3 2.124 2.124 0 0 0 3.004 0 2.12 2.12 0 0 0-.004 3 2 2 0 0 0 2.879-.052L22 15c-1.5-1.5-2-2.5-2.586-3.172" />
    <path d="M15.535 14.414c-.775-.708-1.779-1.06-2.828-1.02" />
    <path d="M11.293 13.394c-1.05-.04-2.053.312-2.828 1.02" />
    <path d="M18 17.917c0-.667-.167-1.167-.5-1.5-.333-.333-.833-.5-1.5-.5-.667 0-1.167.167-1.5.5-.333.333-.5.833-.5 1.5" />
    <path d="M10.5 17.917c0-.667-.167-1.167-.5-1.5-.333-.333-.833-.5-1.5-.5-.667 0-1.167.167-1.5.5-.333.333-.5.833-.5 1.5" />
  </svg>
);
